...
Furthermore, Hars and Ou found that $16\%$ of their participants were paid to contribute to FLOSS projects and over one-third of them viewed their participation as an effective means of self-marketing~\cite{HarOu2002}.
...
%\centering %used for centering table
  \begin{tabular}{| l | l | l | l |}
    ...
    intrinsic & 10/16 & & \\
    \hline
    extrinsic: ideology & 14/16 & & \\
    \hline
    extrinsic: community identification & & & \\
    \hline
    extrinsic: expected approval & & & \\
    \hline
    extrinsic: satisfying (personal) needs & 2(personal)/2(other people's needs)/16 & & \\
    \hline
    extrinsic: external punishment/reward & 1/16 & & \\
    \hline
  \end{tabular}
  \caption{Types of motivation in the Freifunk and FLOSS communities\footnote{Next to the percentages the table shows how many of the total number of participants found certain type of motivation relevant.
  The numbers for the Freifunk community combine the answers of the general and more specific interview parts.}.}
